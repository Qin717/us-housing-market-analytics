...
DROP TABLE IF EXISTS q3_top5_states_strongest_divergence_home_rent_growth;

CREATE TABLE q3_top5_states_strongest_divergence_home_rent_growth AS
SELECT
...
FROM q3_top5_states_strongest_divergence_home_rent_growth d
JOIN (
    SELECT
